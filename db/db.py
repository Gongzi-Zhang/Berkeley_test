...
if __name__ == '__main__':
    ...
    if args.subcommand == 'init':
        ...
        if args.insert_csv_file:
            insert_to_table1(conn, table, args.insert_csv_file)
        else:
            record = {}
            if args.insert_test_id:
                record['test_id'] = int(args.insert_test_id)
            record['SiPM_id'] = int(args.insert_SiPM_id)
            ...
            if args.insert_end_time:
                record['end_time'] = args.insert_end_time
